...
## Creating and linking a new repository

Github has the steps on display when you make a new repo, but here they are anyway:
1. `echo "# inkfinder_documentation" >> README.md` OR `nano README.md`
2. `git init`
3. `git add README.md`
4. `git commit -m "first commit"`
5. `git branch -M main`
6. `git remote add origin [ssh link to repo]`
